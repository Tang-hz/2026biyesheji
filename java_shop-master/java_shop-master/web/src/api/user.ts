...
const updateUsernameApi = async (params: any) => post<any>({ url: URL.updateUsername, params: params });
...
export { loginApi, listApi, detailApi, createApi, updateApi, deleteApi, userLoginApi, userRegisterApi, updateUserPwdApi, updateUsernameApi, updateUserInfoApi};
